        ...
        public async Task InvokeAsync(HttpContext httpContext)
        {
            ...
            catch (DbException dbEx)
            {
                await HandleExceptionAsync(
                    ...
                    dbEx,
                    "Service Unavailable",
                    "Erro ao acessar o banco de dados ou recurso de rede. Tente novamente mais tarde.",
            ...
            catch (SocketException sockEx)
            {
                await HandleExceptionAsync(
                    ...
                    sockEx,
                    "Service Unavailable",
                    "Erro de conectividade de rede ao acessar dependências externas. Tente novamente mais tarde.",
                    StatusCodes.Status503ServiceUnavailable,
                    LogLevel.Error,
                    addRetryAfter: true);
            }
            catch (TimeoutException tex)
            {
                await HandleExceptionAsync(
                    ...
                    tex,
                    "Service Unavailable",
                    "Tempo de operação excedido ao acessar dependência externa. Tente novamente mais tarde.",
                    StatusCodes.Status503ServiceUnavailable,
                    LogLevel.Error,
                    addRetryAfter: true);
            }
